 ...
 */
package com.autoshipservices.jalo;
...
/**
 * This is the extension manager of the Autoshipservices extension.
 */
public class AutoshipservicesManager extends GeneratedAutoshipservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AutoshipservicesManager.class);
	 ...
	 */
	public static AutoshipservicesManager getInstance()
	{
		return (AutoshipservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AutoshipservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AutoshipservicesManager() // NOPMD 
	{
		LOG.debug("constructor of AutoshipservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AutoshipservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AutoshipservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
