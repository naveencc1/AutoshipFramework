...
public class DefaultAutoshipservicesService implements AutoshipservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAutoshipservicesService.class);
	...
	{
		return DefaultAutoshipservicesService.class.getResourceAsStream("/autoshipservices/sap-hybris-platform.png");
	}
