 ...
 */
package com.autoshipbackoffice.jalo;
...
import com.autoshipbackoffice.constants.AutoshipbackofficeConstants;
 ...
 */
public class AutoshipbackofficeManager extends GeneratedAutoshipbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AutoshipbackofficeManager.class.getName());
	 ...
	 */
	public static AutoshipbackofficeManager getInstance()
	{
		return (AutoshipbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AutoshipbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AutoshipbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AutoshipbackofficeManager called.");
		}
	}
