 ...
 */
package com.autoshipfacades.jalo;
...
/**
 * This is the extension manager of the Autoshipfacades extension.
 */
public class AutoshipfacadesManager extends GeneratedAutoshipfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AutoshipfacadesManager.class);
	 ...
	 */
	public static AutoshipfacadesManager getInstance()
	{
		return (AutoshipfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AutoshipfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AutoshipfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of AutoshipfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AutoshipfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AutoshipfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
