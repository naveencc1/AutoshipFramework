...
public class DefaultAutoshipfacadesService implements AutoshipfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAutoshipfacadesService.class);
	...
	{
		return DefaultAutoshipfacadesService.class.getResourceAsStream("/autoshipfacades/sap-hybris-platform.png");
	}
